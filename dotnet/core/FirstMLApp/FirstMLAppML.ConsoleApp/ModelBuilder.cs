...
namespace FirstMLAppML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"D:\GIT\My Tutorial\dotnet\core\FirstMLApp\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\bugton\AppData\Local\Temp\MLVSTools\FirstMLAppML\FirstMLAppML.Model\MLModel.zip";
